...
- **Importører, distributører og bemyndigede repræsentanter** har understøttende pligter til at kontrollere, at det, de sender videre, overholder reglerne.
...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Uacceptabel risiko         | Social scoring, manipulation der udnytter sårbarheder, ukritisk indsamling af ansigtsbilleder, følelsesgenkendelse på arbejdspladser og i skoler           | Forbudt                                                                 |
...
| 2. februar 2025  | Forbudte praksisser forbydes; bestemmelser om AI-kompetencer                                       |
| 2. august 2025   | Regler for AI-modeller til almen brug; rammerne for styring og sanktioner                          |
| 2. august 2026   | Krav om åbenhed for chatbots, deepfakes og lignende                                                |
...
Bødemaksimum er 35 mio. euro eller 7 % af den globale omsætning for forbudte praksisser, 15 mio. euro eller 3 % for de fleste andre overtrædelser og 7,5 mio. euro eller 1 % for at give myndighederne forkerte oplysninger.

## Sammenhængen med de andre rammeværker

- **GDPR** beskytter personoplysninger, uanset hvor de bruges; AI-forordningen regulerer AI-systemer som produkter, uanset om de rører personoplysninger. Et værktøj til CV-screening er omfattet af begge: GDPR for lovlig behandling og automatiske afgørelser, AI-forordningen for systemets design og tilsyn.
...
- **NIST AI RMF** er et frivilligt amerikansk rammeværk, som mange bruger til at strukturere arbejdet med AI-risici, og det passer rimeligt godt til forordningens krav om risikostyring.
...
6. **Governance.** Hun foreslår en AI-politik godkendt af ledelsen, en ejer for hvert AI-system og træning, så medarbejderne forstår de værktøjer, de bruger.
...
- **"Udskydelsen betyder, at vi kan vente."** Pligterne er ikke ændret, kun datoerne. Kortlægning, klassifikation og dialog med leverandører tager tid, og forbud og krav om åbenhed venter ikke.
