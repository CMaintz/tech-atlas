...
**Article 30 – records of processing activities.** A register of what data you process, why, for whom and how long. It is the backbone of most GDPR work.
...
Article 35 requires a **data protection impact assessment** for high-risk processing, and Article 37 requires a data protection officer in certain cases, such as public authorities. Article 83 sets two tiers of maximum fines: up to EUR 10 million or 2 % of global turnover, and up to EUR 20 million or 4 % for breaches of the principles and rights. In Denmark, fines are as a rule set by the courts after Datatilsynet has reported a case to the police.
...
- **D-mærket** combines IT security with responsible data use, which makes it a natural self-assessment for GDPR-heavy smaller businesses.
...
- Include GDPR in **awareness**: wrongly addressed emails are among the most common breaches, and staff need to know they must report them.
