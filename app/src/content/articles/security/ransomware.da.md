...
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1. Adgang**                                     | Angriberen får et første fodfæste                                                                          | Phishing-mail med skadelig vedhæftning eller link; stjålne eller gættede adgangskoder til fjernadgang (VPN, fjernskrivebord) uden MFA; en ikke-rettet sårbarhed i et system, der vender mod internettet; adgang købt af andre kriminelle |
...
Konsekvensen er vigtig: **Et ransomwareangreb er meget ofte også et brud på persondatasikkerheden**, med de anmeldelsespligter det udløser, fx til Datatilsynet efter GDPR, hvis der er personoplysninger involveret.
...
- **Risikovurdering.** Ransomware bør stå som scenarie i risikoregistret med et ærligt bud på, hvor længe organisationen kan fungere uden sine vigtigste systemer.
...
- **Beredskab.** Beredskabs- og kontinuitetsplanerne bør indeholde en ransomware-drejebog: Hvem beslutter hvad? Hvordan isoleres systemerne? Hvordan kommunikerer vi, når mail og intranet er nede? Hvem kan kontaktes uden for arbejdstid? Skrivebordsøvelser afslører hullerne.
