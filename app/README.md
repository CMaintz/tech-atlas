...
npm run lint:content   # the content lint (E1–E11, W1–W7)
...
npm run embed          # re-embed terms for semantic search (after editing a name, alias, summary or plain facet; lint E11)
