...
| **Semantic search is vital**; heavy compute on the **backend**, never in the visitor's browser. | A75-A78 | Supersedes A51-A55. Your log names Supabase + Cloudflare Workers AI; the brief allowed a fallback service, and picking Cloudflare within it was the agent's. |
