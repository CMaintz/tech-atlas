...
| W8 | **Semantic vector embeds older text.** A Term's name, aliases, summary or plain facet changed since `npm run embed` (A52, A76). | Its search-by-meaning match is slightly stale until re-embedded. |
